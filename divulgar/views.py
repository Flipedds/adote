...
def novo_pet(request):
    if request.method == 'GET':
        ...
        if len(nome.strip()) == 0 or len(cidade.strip()) == 0 or len(descricao.strip()) == 0 or len(telefone.strip()) == 0 : #verificar se colocou
...
def remover_pet(request,id):
    ...
    #se o pet não for do usuario não pode ser deletado
